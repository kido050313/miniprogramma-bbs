...
var utils_1 = require("../common/utils"), getClassNames = function(e) {
    return {
...
exports.transition = function(e) {
    return Behavior({
        ...
        methods: {
            ...
            show: function() {
                var e = this, t = this.data, s = t.classNames, n = t.duration, a = utils_1.isObj(n) ? n.leave : n;
