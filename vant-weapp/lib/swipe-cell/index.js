...
var component_1 = require("../common/component"), touch_1 = require("../mixins/touch"), THRESHOLD = .3;
...
component_1.VantComponent({
    ...
    methods: {
        ...
        swipeMove: function(t) {
            void 0 === t && (t = 0);
            var i = "translate3d(" + (this.offset = t) + "px, 0, 0)", e = this.draging ? "none" : ".6s cubic-bezier(0.18, 0.89, 0.32, 1)";
            this.set({
                wrapperStyle: "\n        -webkit-transform: " + i + ";\n        -webkit-transition: " + e + ";\n        transform: " + i + ";\n        transition: " + e + ";\n      "
            });
        },
